    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 z-10 text-center animate-fade-up">
          ...
          <p className="text-white/60 text-xl md:text-2xl max-w-2xl mx-auto mb-10 font-light">
      ...
      <section className="container mx-auto px-4">
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="text-white/40">Handpicked for exceptional quality.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-card h-96 flex flex-col justify-end p-10 relative overflow-hidden group">
            ...
            <div className="z-20">
              ...
              <p className="text-white/60 mb-6">Upgrade your workspace with our latest arrivals.</p>
